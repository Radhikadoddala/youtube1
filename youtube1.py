...
# youtube api key
api_key = 'AIzaSyAoUk_E2EzMNUQrXFQch7ju8qDHT7TkRLk'

# api calling
youtube = googleapiclient.discovery.build("youtube", 'v3', developerKey = api_key)
# MongoDb Connect
client = pymongo.MongoClient("mongodb+srv://radhidoddala:raadhivamsi@cluster0.5y03gxj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
def Create_table_sql():
    mydb=psycopg2.connect(host="localhost",user="postgres",password="raadhivamsi",dbname="youtube_data",port="5432")
    cursor=mydb.cursor()
...
st.subheader(':blue[YOUTUBE DATA HARVESTING AND WAREHOUSING]',divider = 'blue')
st.subheader(":green[Scraping and Store Data to MongoDB]")
...
if channel_id:
    ...
    st.write("Hello user")
    st.write("Here is ur Channel ID :  ", channel_id)

button_clicked = st.button("Scraping and Store in MongoDB")
if button_clicked:
        client = pymongo.MongoClient("mongodb+srv://radhidoddala:raadhivamsi@cluster0.5y03gxj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
        db = client['youtube_data']
        collection1=db["channel_details"]
...
mydb=psycopg2.connect(host="localhost",user="postgres",password="raadhivamsi",database="youtube_data",port="5432")
cursor=mydb.cursor()
cursor.execute('''select Channel_Id from channels''')
rows = cursor.fetchall()
channel_ids = [row[0] for row in rows]
